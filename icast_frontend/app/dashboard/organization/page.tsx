          ...
          <div className="container mx-auto px-6 py-8">
            ...
            <Tabs defaultValue="list" className="space-y-6">
              <TabsList className="bg-white shadow-sm">
                <TabsTrigger value="list" className="data-[state=active]:bg-gray-100">Organization List</TabsTrigger>
                <TabsTrigger value="stats" className="data-[state=active]:bg-gray-100">Organization Stats</TabsTrigger>
              </TabsList>
